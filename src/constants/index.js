...
export const HERO_CONTENT = {
  ...
  introduction:
    "I’m Ani Bassey, a creative frontend developer, crafting immersive and intuitive web experiences.",
  description:
...
export const CONTACT_CONTENT = {
  ...
  email: "anthonybassey53@yahoo.com.com",
  socialLinks: [
    {
      platform: "Twitter",
      url: "https://twitter.com/anibassey4",
      ariaLabel: "Follow me on Twitter",
      icon: "RiTwitterXFill",
    },
    {
      platform: "GitHub",
      url: "https://github.com/windbaacherspress",
      ariaLabel: "View my GitHub profile",
      icon: "RiGithubFill",
    },
    {
      platform: "LinkedIn",
      url: "https://linkedin.com/in/anibassey",
      ariaLabel: "Connect with me on LinkedIn",
      icon: "RiLinkedinFill",
    },
  ],
  footerText: `© ${new Date().getFullYear()} Ani Bassey. All rights reserved.`,
};
